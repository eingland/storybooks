...
SSH_STRING=eingland@storybooks-vm-$(ENV)
OAUTH_CLIENT_ID=391378107192-c5nupcnu1ee76imk1kq7m7tusgskfme6.apps.googleusercontent.com
...
deploy: check-env
	...
	@$(MAKE) ssh-cmd CMD='\
		docker run -d --name=$(CONTAINER_NAME) \
			...
			-p 80:3000 \
			-e PORT=3000 \
			-e \"MONGO_URI=mongodb+srv://storybooks-user-$(ENV):$(call get-secret,atlas_user_password_$(ENV))@storybooks-$(ENV).jygrt.mongodb.net/$(DB_NAME)?retryWrites=true&w=majority\" \
